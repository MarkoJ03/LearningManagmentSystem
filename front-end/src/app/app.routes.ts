...
{ path: 'tipovi-programa', component: TipoviProgramaComponent, data: {requiredRoles: ["ROLE_ADMIN", "ROLE_STUDENTSKA_SLUZBA"]}, canActivate: [authGuard] },
{ path: 'tipovi-programa/dodaj', component: TipProgramaFormaComponent , data: {requiredRoles: ["ROLE_ADMIN", "ROLE_STUDENTSKA_SLUZBA"]}, canActivate: [authGuard]},
{ path: 'tipovi-programa/izmeni/:id', component: TipProgramaFormaComponent, data: {requiredRoles: ["ROLE_ADMIN", "ROLE_STUDENTSKA_SLUZBA"]}, canActivate: [authGuard] },
...
{ path: 'kalendari', component: KalendariComponent, data: {requiredRoles: ["ROLE_ADMIN", "ROLE_STUDENTSKA_SLUZBA", "ROLE_NASTAVNIK"]}, canActivate: [authGuard] },
{ path: 'kalendari/dodaj', component: KalendarFormaComponent, data: {requiredRoles: ["ROLE_ADMIN", "ROLE_STUDENTSKA_SLUZBA", "ROLE_NASTAVNIK"]}, canActivate: [authGuard] },
{ path: 'kalendari/izmeni/:id', component: KalendarFormaComponent, data: {requiredRoles: ["ROLE_ADMIN", "ROLE_STUDENTSKA_SLUZBA", "ROLE_NASTAVNIK"]}, canActivate: [authGuard] },
{ path: 'kalendari/:id', component: KalendarComponent, data: {requiredRoles: ["ROLE_ADMIN", "ROLE_STUDENTSKA_SLUZBA", "ROLE_NASTAVNIK"]}, canActivate: [authGuard] },


{ path: 'sv-obrazac', component: SvObrasciComponent, data: {requiredRoles: ["ROLE_ADMIN", "ROLE_STUDENTSKA_SLUZBA"]}, canActivate: [authGuard] },
...
//       { path: 'predmeti/:id/obavestenja', component: ObavestenjaPredmetaComponent },
    ...
    ], data: {requiredRoles: ["ROLE_STUDENTSKA_SLUZBA"]}, canActivate: [authGuard]
  },
