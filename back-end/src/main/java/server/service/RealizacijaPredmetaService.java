...
public class RealizacijaPredmetaService extends BaseService<RealizacijaPredmeta, RealizacijaPredmetaDTO, Long> {
	...
	protected RealizacijaPredmetaDTO convertToDTO(RealizacijaPredmeta entity) {
		...
		ArrayList<IshodPredmetaDTO> ishodiPredmeta = new ArrayList<>();
		...
		return new RealizacijaPredmetaDTO(entity.getId(), nastavnik, tipNastave, predmet, terminiNastave, ishodiPredmeta, entity.getVidljiv());
	}
	...
	protected RealizacijaPredmeta convertToEntity(RealizacijaPredmetaDTO dto) {
		...
		ArrayList<IshodPredmeta> ishodiPredmeta = new ArrayList<>();
		...
		return new RealizacijaPredmeta(dto.getId(), nastavnik, tipNastave, predmet, terminiNastave, ishodiPredmeta, dto.getVidljiv());
	}
