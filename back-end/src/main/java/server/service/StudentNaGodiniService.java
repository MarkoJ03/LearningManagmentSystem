...
public class StudentNaGodiniService extends BaseService<StudentNaGodini, StudentNaGodiniDTO, Long>{
 ...
 protected CrudRepository<StudentNaGodini, Long> getRepository() {
	...
	protected StudentNaGodiniDTO convertToDTO(StudentNaGodini entity) {
		...
		return new StudentNaGodiniDTO(entity.getId(),entity.getBrojIndeksa(),entity.getDatumUpisa(),studentService.convertToDTO(entity.getStudent()),godinaStudija,null,null,null, entity.getVidljiv());
	}
	...
	protected StudentNaGodini convertToEntity(StudentNaGodiniDTO dto) {
		...
		return new StudentNaGodini(dto.getId(),dto.getBrojIndeksa(),dto.getDatumUpisa(),studentService.convertToEntity(dto.getStudent()), godinaStudija,null,null,null,dto.getVidljiv());
		}
