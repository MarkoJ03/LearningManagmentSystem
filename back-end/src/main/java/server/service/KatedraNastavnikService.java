 ...
 protected CrudRepository<KatedraNastavnik, Long> getRepository() {
	...
	protected KatedraNastavnikDTO convertToDTO(KatedraNastavnik entity) {
		...
		return new KatedraNastavnikDTO(entity.getId(),new KatedraDTO(entity.getKatedra().getId(),entity.getKatedra().getNaziv(),null,null,null,null,entity.getKatedra().getVidljiv())
				,new NastavnikDTO(entity.getNastavnik().getId(), entity.getNastavnik().getIme(),entity.getNastavnik().getPrezime(),entity.getNastavnik().getJmbg(),null,null,null, null, null,null),entity.getVidljiv()); 
	}
