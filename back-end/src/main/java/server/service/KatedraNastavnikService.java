...
public class KatedraNastavnikService extends BaseService<KatedraNastavnik, KatedraNastavnikDTO, Long> {
	...
	protected KatedraNastavnikDTO convertToDTO(KatedraNastavnik entity) {
		...
		return new KatedraNastavnikDTO(entity.getId(),
				new KatedraDTO(entity.getKatedra().getId(), entity.getKatedra().getNaziv(), null, null, null, null,
	...
	protected KatedraNastavnik convertToEntity(KatedraNastavnikDTO dto) {
		...
		return new KatedraNastavnik(dto.getId(),
				new Katedra(dto.getKatedra().getId(), dto.getKatedra().getNaziv(), null, null, null, null, null,
