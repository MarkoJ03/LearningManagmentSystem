...
=======
				...
				new NastavnikDTO(entity.getSekretarDepartmana().getId(), entity.getSekretarDepartmana().getIme(),entity.getSekretarDepartmana().getPrezime(),entity.getSekretarDepartmana().getJmbg(), null, null, null, null, null,null,entity.getSekretarDepartmana().getVidljiv()),
				new NastavnikDTO(entity.getDirektorDepartmana().getId(), entity.getDirektorDepartmana().getIme(),entity.getDirektorDepartmana().getPrezime(),entity.getDirektorDepartmana().getJmbg(),null,null,null, null, null,null,entity.getDirektorDepartmana().getVidljiv()),
...
=======
				...
				new Nastavnik(dto.getSekretarDepartmana().getId(),null, dto.getSekretarDepartmana().getIme(),dto.getSekretarDepartmana().getPrezime(),dto.getSekretarDepartmana().getJmbg(), null, null, null, null ,null,dto.getSekretarDepartmana().getVidljiv()),
				new Nastavnik(dto.getDirektorDepartmana().getId(),null, dto.getDirektorDepartmana().getIme(),dto.getDirektorDepartmana().getPrezime(),dto.getDirektorDepartmana().getJmbg(),null,null,null, null,null,dto.getDirektorDepartmana().getVidljiv()),
						null, dto.getVidljiv());
	}
>>>>>>> development
